...
from .utils import (generate_and_download_document,
                    inflect_fio_in_genitive,
                    format_location, fio_to_initials,
...
def fill_additional_data(request):
    ...
    is_too_template, name_ip_or_too_value = (
    ...
    if request.method == 'POST' and form.is_valid():
        ...
        edited_data.update({
            'name_ip_or_too': edited_data.get('name_ip_or_too', ''),
        })
